...
class ResNet_lsr(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, input_channel=3):
        super(ResNet_lsr, self).__init__()
        self.in_planes = 64
...
def resnet18_lsr(num_classes=10, input_channel=3):
    return ResNet_lsr(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, input_channel=input_channel)

def resnet34_lsr(num_classes=10, input_channel=3):
    return ResNet_lsr(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, input_channel=input_channel)