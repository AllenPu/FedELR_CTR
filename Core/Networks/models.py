...
class CNN_9layer_LSR(nn.Module):
    def __init__(self, input_channel=3, n_outputs=10, dropout_rate=0.25, top_bn=False):
        self.dropout_rate = dropout_rate
        self.top_bn = top_bn
        super(CNN_9layer_LSR, self).__init__()
        self.c1 = nn.Conv2d(input_channel, 128,
